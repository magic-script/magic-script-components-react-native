export const Events = [
  // Scene events
  {
    ...
    handler: (componentManager, elementId) =>
      componentManager.addOnAppStartEventHandler(elementId),
  },
  ...
  // UiNode events
  {
    name: "onActivate",
    handler: (componentManager, elementId) =>
      componentManager.addOnActivateEventHandler(elementId),
  },
  {
    name: "onClick",
    handler: (componentManager, elementId) =>
  ...
  },
  {
    name: "onLongPress",
    handler: (componentManager, elementId) =>
      componentManager.addOnLongPressEventHandler(elementId),
  },
  {
    name: "onRelease",
    handler: (componentManager, elementId) =>
      componentManager.addOnReleaseEventHandler(elementId),
  },
  {
    name: "onEnabled",
    handler: (componentManager, elementId) =>
      componentManager.addOnEnabledEventHandler(elementId),
  },
  {
    name: "onDisabled",
    handler: (componentManager, elementId) =>
      componentManager.addOnDisabledEventHandler(elementId),
  },
  {
    name: "onFocusGained",
    handler: (componentManager, elementId) =>
      componentManager.addOnFocusGainedEventHandler(elementId),
  },
  {
    name: "onFocusLost",
    handler: (componentManager, elementId) =>
      componentManager.addOnFocusLostEventHandler(elementId),
  },
  {
    name: "onUpdate",
    handler: (componentManager, elementId) =>
      componentManager.addOnUpdateEventHandler(elementId),
  },
  {
    name: "onDelete",
    handler: (componentManager, elementId) =>
      componentManager.addOnDeleteEventHandler(elementId),
  },
  ...
  },
  {
    name: "onFileSelected",
    handler: (componentManager, elementId) =>
      componentManager.addOnFileSelectedEventHandler(elementId),
  },
  {
  ...
  // Prism events
  {
    name: "onModeChanged",
    handler: (componentManager, elementId) =>
      componentManager.addOnPrismModeChangedEventHandler(elementId),
  },
  {
    name: "onRotationChanged",
    handler: (componentManager, elementId) =>
      componentManager.addOnPrismRotationChangedEventHandler(elementId),
  },
  {
    name: "onScaleChanged",
    handler: (componentManager, elementId) =>
      componentManager.addOnPrismScaleChangedEventHandler(elementId),
  },
  {
    name: "onPositionChanged",
    handler: (componentManager, elementId) =>
      componentManager.addOnPrismPositionChangedEventHandler(elementId),
  },
];
