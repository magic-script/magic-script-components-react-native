class Log {
  ...
  static activeLogger = {
    info: (message, ...optionalParams) => {
      console.info("[MXS] " + message, ...optionalParams);
    },
    debug: (message, ...optionalParams) => {
      console.log("[MXS] " + message, ...optionalParams);
    },
    warn: (message, ...optionalParams) => {
      console.warn("[MXS] " + message, ...optionalParams);
    },
    error: (message, ...optionalParams) => {
      console.error("[MXS] " + message, ...optionalParams);
    }
  };
