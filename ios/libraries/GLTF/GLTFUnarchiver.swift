...
public class GLTFUnarchiver {
    ...
    private func loadMaterial(index: Int) throws -> SCNMaterial {
        ...
        material.shaderModifiers = [
            .surface: GLTFShaderModifier.surface()
        ]
        #if SEEMS_TO_HAVE_DOUBLESIDED_BUG
            if material.isDoubleSided {
                material.shaderModifiers = [
                    .surface: GLTFShaderModifier.doubleSidedWorkaround()
                ]
            }
        #endif
        ...
        case "BLEND":
            ...
            material.shaderModifiers![.surface] = GLTFShaderModifier.alphaModeBlend()
        case "MASK":
            material.shaderModifiers![.fragment] = GLTFShaderModifier.alphaCutOff()
        default:
