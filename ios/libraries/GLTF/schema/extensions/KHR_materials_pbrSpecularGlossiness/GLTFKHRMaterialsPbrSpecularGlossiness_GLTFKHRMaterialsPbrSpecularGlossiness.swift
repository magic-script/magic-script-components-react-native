    ...
    func didLoad(by object: Any, unarchiver: GLTFUnarchiver) {
        ...
        if let specularGlossinesTexture = data.specularGlossinessTexture {
            ...
            material.shaderModifiers = [
                .surface: GLTFShaderModifier.pbrSpecularGlossinessTextureDoubleSidedWorkaround()
            ]
        } else {
            ...
            material.shaderModifiers = [
                .surface: GLTFShaderModifier.pbrSpecularGlossiness()
            ]
            
            #if SEEMS_TO_HAVE_DOUBLESIDED_BUG
                if material.isDoubleSided {
                    material.shaderModifiers = [
                        .surface: GLTFShaderModifier.pbrSpecularGlossinessDoubleSidedWorkaround()
                    ]
                }
            #endif
        }
