...
RCT_EXTERN_METHOD(connect:(NSString *)connect deviceId:(NSString *)deviceId token:(NSString *)token callback:(RCTResponseSenderBlock)callback)
RCT_EXTERN_METHOD(update:(RCTResponseSenderBlock)callback)
